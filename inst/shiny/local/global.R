...
if (file.exists(precompiled_path)) {
  ...
  tryCatch({
    ...
    cat(sprintf("  Without precompilation: 60-120 seconds\n"))
    cat(sprintf("  Time saved: ~%d seconds! 🚀\n", as.integer(90 - load_time)))
    cat("\n")
    cat("This model is now ready for all users.\n")
    cat("Changing priors will NOT require recompilation.\n")
    cat("\n")
    cat("==========================================================\n")
    cat("IMPORTANT: When you click 'Run Model':\n")
    cat("==========================================================\n")
    cat("  - Model compilation: ALREADY DONE (0 seconds)\n")
    cat("  - MCMC sampling: Will take 10-30 seconds\n")
    cat("\n")
    cat("The 10-30 seconds is MCMC sampling, NOT compilation!\n")
    cat("This is normal and expected for Bayesian inference.\n")
    cat("==========================================================\n")
    cat("\n")
